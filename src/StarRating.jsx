        ...
        <div style={containerStyle}>
            <div style={starContainerStyle}>
                {Array.from({length:maxRating},(_,i)=>(
                    <Star onClick={()=>setRating(i+1)} key={i} fullStar={tempRating ? tempRating>=i+1: rating>= i+1} onHoverIn={()=>setTempRating(i+1)} onHoverOut={()=>setTempRating(0)}/>
                    ))}
            </div>
            <div>
...
function Star({onClick,fullStar, onHoverIn, onHoverOut, size="48px", color="#fcc419"}){
